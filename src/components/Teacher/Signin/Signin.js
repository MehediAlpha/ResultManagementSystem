	...
	onResetPassword = () =>{
		if(this.state.passChangeId.length === 0 || 
			...
			if (this.state.passChangeNewPass === this.state.passChangeRetNewPass) {
				fetch('http://localhost:3001/teacherPasswordChange', {
					method: 'post',
					headers: {'content-type' : 'application/json',
								'Accept': 'application/json'},
					body: JSON.stringify({
			...
			<main className="pa5 ba b--black dib br4 ma shadow-5 bg-white css">
			  <div className="measure center">
				<fieldset id="sign_up" className="ba b--transparent ph0 mh0">
				  <legend className="f2-l fw6 ph0 mh0 ttu black">Sign In as Teacher</legend>
				  <div className="mt3">
				...
				<div className="">
				  <input onClick={this.onSubmitChange} className="b pa3 ph4 ba b--orange bg-orange white grow pointer f4-l mt2" type="submit" value="Sign in"/>
				</div>
				<div className="lh-copy mt3 grow">
				  <a href="#0" className="f4-l black black hover-black " onClick={()=>this.props.onRoute('signin')}>Go Back!</a>
				</div>
				<br/>
